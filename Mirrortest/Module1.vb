Module Module1
    ...
    Private Property selectLoop As Boolean = True
    'Added userInput to get user input
    Private Property userInput As String
    ...
    Sub Main()
        ...
        While selectLoop = True
            ...
            Else
                ...
                'With Bruh() anywhere you want in your program.
                Bruh()
    ...
    Sub StoryArc1()
        ...
        Console.WriteLine("")
        selectLoop = True 'Reset selectLoop to true
        userInput = ""
        While selectLoop = True
            ...
            'scissors choice. switched varrible scissors to userChoice so you don't have a ton of varribles doing the same task.
            'You can reuse a varrible once it's been cleared to something. 
            userInput = Console.ReadLine()
            If userInput = "1" Then
                'Take the scissors Sub module
                Scissors()
                selectLoop = False
            ElseIf userInput = "2" Then
                'Hesitation sub module
                Hesitation()
                selectLoop = False
            Else
                Bruh()
    ...
    Sub Scissors()
        ...
        Console.WriteLine("To continue press Enter") 'Now pressing Enter to continue.
        Console.ReadLine() 'No need to set var...
        ...
        Console.WriteLine("")
        'Reset userInput and selectLoop
        userInput = ""
        selectLoop = True
        While selectLoop = True
